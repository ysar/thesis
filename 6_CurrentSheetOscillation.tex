...
\begin{enumerate}
    ...
    \item What are the differences in the response of a magnetosphere to a forward shock in the solar wind when using an idealized versus a tilted dipole for the internal field?yino3w2 
\end{enumerate}

% Insert paragraph about the rellationship between the current sheet location and the solar wind dynamics pressure
...
\begin{enumerate}
    ...
    \item The \citeA{Khurana1992a} model described by Equation \ref{eqn:khurana1992} with three parameters - $v_0$, $x_0$ and $\rho_0$.
\end{enumerate}
